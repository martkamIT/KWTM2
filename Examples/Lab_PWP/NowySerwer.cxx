/*=========================================================================
  ...
  Program:   OpenIGTLink -- Example for Data Receiving Server Program -- NowySerwer
  Language:  C++
  ...
  if (c & igtl::MessageHeader::UNPACK_BODY) // if CRC check is OK
    ...
    for (int i = 0; i < nElements; i ++)
      ...
      for (size_t i=0; i <3; i++)
        ...
        std::cerr << "Change of sign for each coordinate: ( " << std::fixed << pos[0] << ", " << pos[1] << ", " << pos[2] << " )" << std::endl;
